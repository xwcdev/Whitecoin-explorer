<template>
  <div class="wrap" :class="{mobile: isMobile}">
    ...
    <main>
      <h2>{{$t('address.overview.title')}}</h2>
      <section class="clear">
        <div class="left">
          <ul>
            <li>
            ...
            <li>
              <span>{{$t('address.overview.address')}}</span>
              <span>
                {{minerInfo.address}}
                <span
                  style="color: red;"
            ...
            <li>
              <span>{{$t('address.overview.balances')}}</span>
              <span>
        ...
        <div class="right">
          <ul>
            ...
            <li>
              <span>{{$t('miner.overview.rewards')}}</span>
              <span>{{minerInfo.rewards}}</span>
            </li>
            <li>
            ...
            <li>
              <span>{{$t('address.overview.paybackBalances')}}</span>
              <span>
                <template v-for="(item, index) in minerInfo.paybackBalances">
                  {{item}}
                  <template v-if="index < minerInfo.paybackBalances.length - 1">,</template>
                </template>
              </span>
            </li>
          </ul>
